...
class _ProfileScreenState extends State<NewUserProfileScreen> with SingleTickerProviderStateMixin {
          ...
          child: Column(
            children: [
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.network(
                          studentData!['picture_data'] ?? '', // Use an empty string if the photo is null
                          fit: BoxFit.fill,
              ...
              _buildAnimatedSection('Personal Information', [
                ...
                buildProfileRow('Blood Group', studentData!['blood_group'].toString()??''),
              ]),
              const SizedBox(height: 20),
              _buildAnimatedSection('Academic Information', [
                buildProfileRow('Class', studentData!['class_name']??'N/A'),
                ...
                // ),
                buildProfileRow('Admission Number', studentData!['unique_id']??''),
              ]),
              const SizedBox(height: 20),
              _buildAnimatedSection('Contact Information', [
                buildProfileRow('Contact Person', studentData!['contact_person']??''),
                buildProfileRow('Contact Number', studentData!['contact']??''),
